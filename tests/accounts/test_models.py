...
class TestState:
    def test_str_method(self):
        obj = State.objects.get(name='Kansas')
        assert str(obj) == 'Kansas'

    def test_fields(self):
        obj = State.objects.get(name='Kansas')
        assert obj.name == 'Kansas'


class TestCity:
    def test_str_method(self):
        obj = City.objects.get(name='Warrensburg')
        assert str(obj) == 'Warrensburg'

    def test_fields(self):
        obj = City.objects.get(name='Warrensburg')
        assert obj.name == 'Warrensburg'
...
class TestAddress:
    def test_str_method(self, load_data):
        ...
        assert str(obj) == 'Address1-customer1,Address2-customer1, Street-customer1,' \
                           ' Landmark-customer1, Warrensburg, 123456, Kansas'
    ...
    def test_fields(self, load_data):
        ...
        assert obj.state.name == 'Kansas'
        assert obj.city.name == 'Warrensburg'
