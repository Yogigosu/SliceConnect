...
class TestRestaurantModel:
    ...
    def test_get_restaurant_address(self, load_data):
        ...
        assert result[1] == 'Address1-res4,Address2-res4, Street-res4, Landmark-res4, Warrensburg, 123456, Kansas'
...
class TestDocumentsModel:
    ...
    def test_documents_data(self, load_data):
        ...
        assert documents.pan_card == "pan_cards/Screenshot_from_2024-05-15_11-43-54_3C6tW3O.png"
        assert documents.gst_certificate == "gst_certificates/Screenshot_from_2024-05-09_10-17-03.png"
        assert documents.fssai_certificate == "fssai_certificates/Screenshot_from_2024-05-12_12-52-50_Y06WKTg.png"
...
class TestItemsModel:
    ...
    def test_items_data(self, load_data):
        ...
        assert item.image == "item_images/Screenshot_from_2024-05-12_12-52-50_3RXZ4YQ.png"
