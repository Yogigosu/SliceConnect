...
# User_id = 8, Address_id = 7(Warrensburg)
...
# Description:
# 1 Active restaurant owner with 1 Verified Restaurant(Warrensburg) with three items and is accepting orders
...
# Description:
# 1 Active restaurant owner with 1 Verified and Blocked Restaurant(Warrensburg)
...
# 1 Active and Verified agent(Warrensburg)
